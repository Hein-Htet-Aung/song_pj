...
<?php include_once "include_admin/sidebar.php"; ?>
    ...
    <?php 
     ...
     move_uploaded_file($song_image_temp,"img/$image");
      ...
      $query="INSERT INTO album(album_name, image) VALUES ('$album','$image')";
      $result = mysqli_query($con,$query);
    if(!$result) {
      die("Query Failed" . mysqli_error($result));
    }
    echo "Created Artist Successfully"."<a href='artistlist.php'>View All Artist</a>";
...
?>
 ...
 <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main" >     
      <!--/.row-->
    <div class="container col-lg-12" style="width: 500px;margin-left: 230px;padding-top: 100px;">
